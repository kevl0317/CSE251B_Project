...
from model_combined import GPTConfig, GPT

# -----------------------------------------------------------------------------
# Small model + 10k iteration config
...
# -----------------------------------------------------------------------------
# WSD (Warmup-Stable-Decay) learning rate schedule with short stable phase
#   warmup:       0 → peak LR  (steps 0 to warmup_iters)
